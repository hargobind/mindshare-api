...
jQuery(document).ready(function($) {
	 ...
	 * @since 1.1
	 */
	/*jQuery( ".at-repeater-item" ).on('click', function() {
	 ...
	 */
	jQuery('.at-color').on('focus', function() {
		var $this = jQuery(this);
		jQuery(this).siblings('.at-color-picker').farbtastic($this).toggle();
	});
	jQuery('.at-color').on('focusout', function() {
		var $this = jQuery(this);
		jQuery(this).siblings('.at-color-picker').farbtastic($this).toggle();
	});
	/**
	 ...
	 * @since 1.0
	 */
	jQuery('.at-color-select').on('click', function() {
		var $this = jQuery(this);
	...
	//delete img button
	jQuery('.at-delete_image_button').on('click', function(e) {
	...
	var formfield1;
	var formfield2;
	jQuery('.at-upload_image_button').on('click', function(e) {
	 ...
	 * @return void
	 */
	jQuery("#apc_import_b").on("click", function() {
	 ...
	 * @return void
	 */
	jQuery("#apc_export_b").on("click", function() {
		do_ajax_import_export('export');
	});
	jQuery("#apc_refresh_page_b").on("click", function() {
		refresh_page();
	});
	/**
	 * refresh_page
